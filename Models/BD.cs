...
public class BD
{
    ...
    {
        string sql = "INSERT INTO Candidato (IdCandidato, IdPartido, Apellido, Nombre, Fechanacimiento, Foto, Postulacion) " +
                     "VALUES (@IdCandidato, @IdPartido, @Apellido, @Nombre, @Fechanacimiento, @Foto, @Postulacion);";

        using (SqlConnection conexion = new SqlConnection(_connectionString))
        {
            conexion.Execute(sql, can);
        }
    }
    ...
    {
        string sql = "SELECT IdCandidato, IdPartido, Apellido, Nombre, Fechanacimiento, Foto, Postulacion " +
                     "FROM Candidato WHERE IdPartido = @IdPartido;";
